...
class Rocket {
  constructor() {
    ...
    // materials
    let matRoof1 = new THREE.MeshLambertMaterial({
      color: Colors.red1,
      flatShading: true,
    });
    let matRoof2 = new THREE.MeshLambertMaterial({
      color: Colors.red2,
      flatShading: true,
    });
    ...
    let matBody = new THREE.MeshBasicMaterial({
      color: 0x999999,
      flatShading: true,
    });
    let matWindowFrame = new THREE.MeshBasicMaterial({
      color: Colors.darkGrey,
      side: THREE.DoubleSide,
      flatShading: true,
    });
    let matWindow = new THREE.MeshLambertMaterial({
      color: Colors.windowDarkBlue,
    });
    let matWindowReflection = new THREE.MeshLambertMaterial({
      color: Colors.windowBlue,
    });
    let matThruster = new THREE.MeshLambertMaterial({
    ...
    mWindowReflection.receiveShadow = false;
